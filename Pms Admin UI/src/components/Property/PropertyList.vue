    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-6">
              <label class="title headersize">Properties</label>
            </div>
            <div class="col-lg-6">
              <button class="btn btn-primary btn-small" style="float:right" v-on:click="addNew">New Property</button>
            </div>
          </div>
          <hr />
        </div>
        <div class="card-content row">
          ...
          <div class="card-content table-responsive table-full-width table">
            <el-table :data="queriedData">
              <el-table-column class="success" label="Address" property="address1"></el-table-column>
              <el-table-column :min-width="120" label="Title No" property="titleNo"></el-table-column>
              <el-table-column class="danger" label="Rooms" property="numberOfRooms"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      fetchList() {
        ...
        this.$store.dispatch('property/fetchList').catch(e => {
          this.errorMessage = e
          swal({
            title: 'Warning',
      ...
      handleEdit(index, row) {
        ...
        this.$router.push(`/property/edit/${newId}`)
      ...
      handleDelete(index, row) {
        ...
        swal({
          ...
          root.$store.dispatch('property/delete', row.id)
          root.fetchList();
        })
    ...
    computed: {
      ...mapState({
        ...
        isLoading: state => state.property.isLoading,
      }),
      parsedDirection() {
