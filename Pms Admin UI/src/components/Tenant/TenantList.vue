    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-6">
              <label class="title headersize">Tenants</label>
            </div>
            <div class="col-lg-6">
              <button class="btn btn-primary btn-small" style="float:right" v-on:click="addNew">New Tenant</button>
            </div>
          </div>
          <hr />
        </div>
        <div class="card-content row">
          ...
          <div class="card-content table-responsive table-full-width table">
            <el-table :data="queriedData">
              <el-table-column class="success" label="First Name" property="firstName"></el-table-column>
              <el-table-column :min-width="120" label="Last Name" property="lastName"></el-table-column>
              <el-table-column class="danger" label="Claim Number" property="claimNumber"></el-table-column>
              <el-table-column class="info" label="Email" property="email"></el-table-column>
              <el-table-column label="Mobile" property="mobile"></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      fetchList() {
        ...
        this.$store.dispatch('tenant/fetchList').catch(e => {
          this.errorMessage = e
          //swal({
          //  title: 'Worng',
      ...
      handleEdit(index, row) {
        ...
        this.$router.push(`/tenants/edit/${newId}`)
      ...
      handleDelete(index, row) {
        ...
        swal({
          ...
          root.$store.dispatch('tenant/delete', row.id)
          root.fetchList();
        })
    ...
    computed: {
      ...mapState({
        list: state => state.tenant.list,
        isLoading: state => state.tenant.isLoading,
      }),
      parsedDirection() {
