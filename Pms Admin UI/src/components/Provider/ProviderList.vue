    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-6">
              <label class="title headersize">Providers</label>
            </div>
            <div class="col-lg-6">
  ...
  export default {
    ...
    methods: {
      ...
      fetchList() {
        ...
        this.$store.dispatch('provider/fetchList').catch(e => {
          this.errorMessage = e
          swal({
            title: 'Warning',
      ...
      handleEdit(index, row) {
        ...
        this.$router.push(`/provider/edit/${newId}`)
      ...
      handleDelete(index, row) {
        ...
        swal({
          ...
          root.$store.dispatch('provider/delete', row.id)
          root.fetchList();
        })
    ...
    computed: {
      ...mapState({
        list: state => state.provider.list,
        isLoading: state => state.provider.isLoading,
      }),
      parsedDirection() {
